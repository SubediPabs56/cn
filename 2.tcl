...
$ns attach-agent $n1 $tcp0 set sink0 [new Agent/TCPSink]
$ns attach-agent $n6 $sink0
$ns connect $tcp0 $sink0 set ftp [new Application/FTP]
$ftp attach-agent $tcp0
$ns at 1.2 "$ftp start"
set tcp1 [new Agent/TCP]
$ns attach-agent $n2 $tcp1 set sink1 [new Agent/TCPSink]
...
set time 0.01
set now [$ns now]
set cwnd [$tcpSource set cwnd_] puts $file "$now
$cwnd"
...
$tf
close $nf
puts "running nam..." puts "FTP PACKETS.."
puts "Telnet PACKETS.." exec nam ex2.nam &
exec xgraph win2.tr & exit 0
}
$ns run
